...
const SKILLS = [
  ...
  { name: 'PowerShell',   cat: 'lang',    catLabel: 'Language',   level: 0.68 },
  // Web Development
...
(function initTerminal() {
  ...
  const CMDS = {
    ...
    skills: () => [
      ...
      '  Languages   → C++, Python, Dart, JavaScript, SQL, PowerShell',
      '  Web         → HTML & CSS, JavaScript',
      '  Mobile      → Flutter, Firebase',
      '  Data        → NumPy, Pandas, Power BI',
      '  Dev Tools   → Git & GitHub, GitLab, VS Code, Microsoft Office',
      '  CS Core     → Data Structures, Algorithms, OOP, Systems Programming',
    ...
    projects: () => [
      ...
      '  <span class="t-accent">[02] Mahishmathi</span>  — C++ SimCity-style city simulation',
      '  <span class="t-accent">[03] Menu Driven</span>  — Console list manager',
    ...
    education: () => [
      ...
      '  GPA: <span class="t-amber">3.72 / 4.0</span>',
    ...
    contact: () => [
      ...
      '  GitHub   → <a href="https://github.com/dashboard" target="_blank" style="color:inherit">github.com/dashboard</a>',
